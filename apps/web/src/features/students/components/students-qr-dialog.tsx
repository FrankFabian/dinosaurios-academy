  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
            ...
            // ✅ quita el cap del max-w por defecto del DialogContent
            "max-w-none",
            // ✅ responsive: en mobile casi full, en desktop un ancho cómodo
        ...
        >
            ...
            >
                ...
                <QRCodeCanvas value={student.qrCodeValue} size={220} marginSize={4} />
                </div>
            </div>
