...
import { GROUP_GENDERS, GROUP_STATUS, WEEK_DAYS, type GroupRow } from "../types";
import {
  WEEK_DAY_LABEL,
  formatMinute,
...
export function GroupEditForm({ group }: { group: GroupRow }) {
  ...
  function onSubmit(values: GroupEditFormValues) {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex items-center justify-end gap-2">
            <Button type="submit" disabled={isFormDisabled} className="bg-emerald-500 text-black hover:bg-emerald-400">
